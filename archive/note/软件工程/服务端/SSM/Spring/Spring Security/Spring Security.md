...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/cdeb2d5db0b0276684a3d8d15c422428.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/1758e4c19bd45797607111ef54e64916.png)
...
- `SecurityContextPersistenceFilter`
    主要控制 SecurityContext 的在一次请求中的[生命周期](https://so.csdn.net/so/search?q=%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F&spm=1001.2101.3001.7020)，请求结束时清空，防止内存泄漏
...
​ 我们可以通过Debug(alt+f8)查看当前系统中SpringSecurity过滤器链中有哪些过滤器及它们的顺序。

##### 2.2.2 认证流程详解

![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/4c38aa717331c9403158be59e51b414f.png)
...
`UserDetailsService`接口：加载用户特定数据的核心接口。里面定义了一个根据用户名查询用户信息的方法。(底层实现是基于内存的实现，需要重写，连接数据库)
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/9eccc638ed8bb9116b1f9e30096a3e59.png)
