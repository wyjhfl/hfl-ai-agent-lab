...
### [#](https://javabetter.cn/collection/PriorityQueue.html#priorityqueue%E7%9A%84%E4%BD%9C%E7%94%A8)PriorityQueue的作用
...
### [#](https://javabetter.cn/collection/PriorityQueue.html#%E6%96%B9%E6%B3%95%E5%89%96%E6%9E%90)方法剖析

#### [#](https://javabetter.cn/collection/PriorityQueue.html#add-%E5%92%8C-offer)add()和 offer()
...
#### [#](https://javabetter.cn/collection/PriorityQueue.html#element-%E5%92%8C-peek)element()和 peek()
...
#### [#](https://javabetter.cn/collection/PriorityQueue.html#remove-%E5%92%8C-poll)remove()和 poll()
...
#### [#](https://javabetter.cn/collection/PriorityQueue.html#remove-object-o)remove(Object o)

`remove(Object o)`方法用于删除队列中跟`o`相等的某一个元素（如果有多个相等，只删除一个），该方法不是_Queue_接口内的方法，而是_Collection_接口的方法。由于删除操作会改变队列结构，所以要进行调整；又由于删除元素的位置可能是任意的，所以调整过程比其它方法稍加繁琐。
...
### [#](https://javabetter.cn/collection/PriorityQueue.html#%E5%B0%8F%E7%BB%93)小结
...
可以通过 LeetCode 的第 23 题：[合并K个升序链表open in new window](https://leetcode-cn.com/problems/merge-k-sorted-lists/) 来练习 PriorityQueue 的使用。

我把题解已经放到了技术派中，大家可以去作为参考。

[合并K个升序链表open in new window](https://paicoding.com/column/7/23)
