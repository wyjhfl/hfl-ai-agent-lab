...
同学们好啊，还记得 [HashMapopen in new window](https://javabetter.cn/collection/hashmap.html) 那篇吗？我自己感觉写得非常棒啊，既通俗易懂，又深入源码，真的是分析得透透彻彻、清清楚楚、明明白白的。（一不小心又甩了三个成语，有文化吧？）HashMap 哪哪都好，真的，只要你想用键值对，第一时间就应该想到它。

为了提高查找效率，HashMap 在插入的时候对键做了一次哈希算法，这就导致插入的元素是无序的。

对这一点还不太明白的同学，可以再回到 [HashMapopen in new window](https://javabetter.cn/collection/hashmap.html) 那一篇，看看 hash 方法，再看看我对 `put()` 方法的讲解，就能明白了，我们这里再来回顾一下。
...
关于双向链表，同学们可以回头看一遍我写的 [LinkedListopen in new window](https://javabetter.cn/collection/linkedlist.html) 那篇文章，会对理解本篇的 LinkedHashMap 有很大的帮助。
...
### [#](https://javabetter.cn/collection/linkedhashmap.html#_01%E3%80%81%E6%8F%92%E5%85%A5%E9%A1%BA%E5%BA%8F)01、插入顺序

在 [HashMapopen in new window](https://javabetter.cn/collection/hashmap.html) 那篇文章里，我有讲解到一点，不知道同学们记不记得，就是 null 会插入到 HashMap 的第一位。
...
### [#](https://javabetter.cn/collection/linkedhashmap.html#_02%E3%80%81%E8%AE%BF%E9%97%AE%E9%A1%BA%E5%BA%8F)02、访问顺序
...
第一个参数和第二个参数，看过 [HashMapopen in new window](https://javabetter.cn/collection/hashmap.html) 的同学们应该很熟悉了，指的是初始容量和负载因子。
...
### [#](https://javabetter.cn/collection/linkedhashmap.html#_03%E3%80%81%E5%B0%8F%E7%BB%93)03、小结
