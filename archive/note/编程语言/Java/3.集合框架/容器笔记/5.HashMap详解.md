这篇文章将会详细透彻地讲清楚 Java 的 HashMap，包括 hash 方法的原理、HashMap 的扩容机制、HashMap 的加载因子为什么是 0.75 而不是 0.6、0.8，以及 HashMap 为什么是线程不安全的，基本上 HashMap 的[常见面试题open in new window](https://javabebetter.cn/interview/java-hashmap-13.html)，都会在这一篇文章里讲明白。
...
### [#](https://javabetter.cn/collection/hashmap.html#_01%E3%80%81hash-%E6%96%B9%E6%B3%95%E7%9A%84%E5%8E%9F%E7%90%86)01、hash 方法的原理
...
#### [#](https://javabetter.cn/collection/hashmap.html#hash-%E6%96%B9%E6%B3%95%E7%9A%84%E4%BD%9C%E7%94%A8)hash 方法的作用
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E5%8F%96%E6%A8%A1%E8%BF%90%E7%AE%97-vs-%E5%8F%96%E4%BD%99%E8%BF%90%E7%AE%97-vs-%E4%B8%8E%E8%BF%90%E7%AE%97)取模运算 VS 取余运算 VS 与运算
...
推荐阅读：[Java 取模和取余open in new window](https://www.cnblogs.com/doondo/p/14678204.html)
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E5%8F%96%E6%A8%A1%E8%BF%90%E7%AE%97-%E5%92%8C%E4%BD%8D%E8%BF%90%E7%AE%97)取模运算%和位运算&
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E4%B8%BA%E4%BB%80%E4%B9%88%E5%8F%96%E6%A8%A1%E8%BF%90%E7%AE%97%E4%B9%8B%E5%89%8D%E8%A6%81%E8%B0%83%E7%94%A8-hash-%E6%96%B9%E6%B3%95%E5%91%A2)为什么取模运算之前要调用 hash 方法呢？
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E5%B0%8F%E7%BB%93)小结
...
### [#](https://javabetter.cn/collection/hashmap.html#_02%E3%80%81hashmap-%E7%9A%84%E6%89%A9%E5%AE%B9%E6%9C%BA%E5%88%B6)02、HashMap 的扩容机制

好，理解了 hash 方法后我们来看第二个问题，HashMap 的扩容机制。

大家都知道，数组一旦初始化后大小就无法改变了，所以就有了 [ArrayListopen in new window](https://javabebetter.cn/collection/arraylist.html)这种“动态数组”，可以自动扩容。
...
这就意味着，要采用拉链法（后面会讲）将他们放在同一个索引的链表上。查询的时候，就不能直接通过索引的方式直接拿到（[时间复杂度open in new window](https://javabebetter.cn/collection/time-complexity.html)为 O(1)），而要通过遍历的方式（时间复杂度为 O(n)）。
...
#### [#](https://javabetter.cn/collection/hashmap.html#resize-%E6%96%B9%E6%B3%95)resize 方法
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E6%96%B0%E5%AE%B9%E9%87%8F-newcapacity)新容量 newCapacity
...
#### [#](https://javabetter.cn/collection/hashmap.html#transfer-%E6%96%B9%E6%B3%95)transfer 方法
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E6%8B%89%E9%93%BE%E6%B3%95)拉链法
...
#### [#](https://javabetter.cn/collection/hashmap.html#java-8-%E6%89%A9%E5%AE%B9)Java 8 扩容
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E5%B0%8F%E7%BB%93-1)小结
...
### [#](https://javabetter.cn/collection/hashmap.html#_03%E3%80%81%E5%8A%A0%E8%BD%BD%E5%9B%A0%E5%AD%90%E4%B8%BA%E4%BB%80%E4%B9%88%E6%98%AF-0-75)03、加载因子为什么是 0.75
...
Java 8 之前，HashMap 使用链表来解决冲突，即当两个或者多个键映射到同一个桶时，它们被放在同一个桶的链表上。当链表上的节点（Node）过多时，链表会变得很长，查找的效率（[LinkedListopen in new window](https://javabebetter.cn/collection/linkedlist.html) 的查找效率为 O（n））就会受到影响。

Java 8 中，当链表的节点数超过一个阈值（8）时，链表将转为红黑树（节点为 TreeNode），红黑树（在讲[TreeMapopen in new window](https://javabebetter.cn/collection/treemap.html)时会细说）是一种高效的平衡树结构，能够在 O(log n) 的时间内完成插入、删除和查找等操作。这种结构在节点数很多时，可以提高 HashMap 的性能和可伸缩性。
...
这时候，我们对于该公式其实最想求的时候长度 s 的时候，n 为多少次就应该进行扩容了？而负载因子则是n/s的值。所以推导如下：
...
这就是一个求 `∞⋅0`函数极限问题，这里我们先令（）s=m+1（m→∞）则转化为
...
#### [#](https://javabetter.cn/collection/hashmap.html#%E5%B0%8F%E7%BB%93-2)小结
...
### [#](https://javabetter.cn/collection/hashmap.html#_04%E3%80%81%E7%BA%BF%E7%A8%8B%E4%B8%8D%E5%AE%89%E5%85%A8)04、线程不安全

其实这个问题也不用说太多，但考虑到[面试的时候有些面试官会问open in new window](https://javabebetter.cn/interview/java-hashmap-13.html)，那就简单说一下。
...
#### [#](https://javabetter.cn/collection/hashmap.html#_1-%E5%A4%9A%E7%BA%BF%E7%A8%8B%E4%B8%8B%E6%89%A9%E5%AE%B9%E4%BC%9A%E6%AD%BB%E5%BE%AA%E7%8E%AF)1）多线程下扩容会死循环
...
#### [#](https://javabetter.cn/collection/hashmap.html#_2-%E5%A4%9A%E7%BA%BF%E7%A8%8B%E4%B8%8B-put-%E4%BC%9A%E5%AF%BC%E8%87%B4%E5%85%83%E7%B4%A0%E4%B8%A2%E5%A4%B1)2）多线程下 put 会导致元素丢失
...
#### [#](https://javabetter.cn/collection/hashmap.html#_3-put-%E5%92%8C-get-%E5%B9%B6%E5%8F%91%E6%97%B6%E4%BC%9A%E5%AF%BC%E8%87%B4-get-%E5%88%B0-null)3）put 和 get 并发时会导致 get 到 null
...
> - [https://blog.csdn.net/lonyw/article/details/80519652open in new window](https://blog.csdn.net/lonyw/article/details/80519652)
> - [https://zhuanlan.zhihu.com/p/91636401open in new window](https://zhuanlan.zhihu.com/p/91636401)
> - [https://www.zhihu.com/question/20733617open in new window](https://www.zhihu.com/question/20733617)
> - [https://zhuanlan.zhihu.com/p/21673805open in new window](https://zhuanlan.zhihu.com/p/21673805)

#### [#](https://javabetter.cn/collection/hashmap.html#_4-%E5%B0%8F%E7%BB%93)4）小结
...
为了解决这个问题，Java 提供了线程安全的 HashMap 实现类 [ConcurrentHashMapopen in new window](https://javabebetter.cn/thread/ConcurrentHashMap.html)。ConcurrentHashMap 内部采用了分段锁（Segment），将整个 Map 拆分为多个小的 HashMap，每个小的 HashMap 都有自己的锁，不同的线程可以同时访问不同的小 Map，从而实现了线程安全。在进行插入、删除和扩容等操作时，只需要锁住当前小 Map，不会对整个 Map 进行锁定，提高了并发访问的效率。

### [#](https://javabetter.cn/collection/hashmap.html#_05%E3%80%81%E5%B0%8F%E7%BB%93)05、小结
...
- HashMap 是线程不安全的，因此在多线程环境下需要使用[ConcurrentHashMapopen in new window](https://javabebetter.cn/thread/ConcurrentHashMap.html)来保证线程安全。
...
- HashMap 在遍历时是无序的，因此如果需要有序遍历，可以使用[TreeMapopen in new window](https://javabebetter.cn/collection/treemap.html)。
...
> - [二哥的 LeetCode 刷题笔记：001.两数之和open in new window](https://paicoding.com/column/7/1)
