...
| 5 | Agent Runtime | [Agent Runtime](/note/AI-Agent/agent-runtime) | 理解 Agent 运行时循环、状态管理、工具编排和停止条件 |
| 6 | Memory / Persistence | [Memory / Persistence](/note/AI-Agent/memory) | 理解短期记忆、长期记忆、上下文压缩和持久化策略 |
...
| 9 | Guardrails / Human Approval | [Guardrails / Safety](/note/AI-Agent/guardrails)、[Human-in-the-loop](/note/AI-Agent/human-in-the-loop) | 理解安全边界、权限控制、Hook 拦截和人工审批 |
| 10 | Agent Harness | [Agent Harness 总览](/note/AI-Agent/agent-harness) | 理解 Runtime、Memory、Tool、Guardrails、Trace、Eval 如何组成生产级骨架 |
| 11 | Trace / Evaluation | [Trace 与 Evaluation](/note/AI-Agent/evaluation) | 理解 Trace 记录、自动评测、失败样本沉淀 |
| 12 | Production Engineering | [Production Engineering](/note/AI-Agent/production) | 理解部署、监控、成本控制、Prompt 管理 |
