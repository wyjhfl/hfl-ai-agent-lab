...
| 7 | Realtime Voice Agent | [Realtime Voice Agent](/note/AI-Agent/realtime-voice-agent)、[Realtime Voice Agent Engineering](/note/AI-Agent/realtime-voice-agent-engineering) | 理解低延迟语音交互、打断、语音 UI、高风险确认、状态和工具调用 |
| 8 | Browser / Computer Use Agent | [Browser / Computer Use Agent](/note/AI-Agent/browser-computer-use-agent)、[Computer Use Agent Safety](/note/Engineering/computer-use-agent-safety) | 理解 GUI 自动化、浏览器操作、截图/DOM 观察、高风险动作审批和第三方指令隔离 |
| 9 | Agent Runtime | [Agent Runtime](/note/AI-Agent/agent-runtime)、[OpenAI Agents SDK Engineering](/note/Engineering/openai-agents-sdk-engineering)、[Responses API Tool Orchestration](/note/Engineering/responses-api-tool-orchestration) | 理解 Agent 运行时循环、状态管理、工具编排、handoff、guardrail 和停止条件 |
| 10 | Memory / Persistence | [Memory / Persistence](/note/AI-Agent/memory)、[Agent Memory Store Design](/note/Engineering/agent-memory-store-design) | 理解短期记忆、长期记忆、上下文压缩、写入策略、遗忘和持久化策略 |
...
| 15 | Agent Harness | [Agent Harness 总览](/note/AI-Agent/agent-harness) | 理解 Runtime、Memory、Tool、Guardrails、Trace、Eval 如何组成生产级骨架 |
| 16 | Trace / Evaluation | [Trace 与 Evaluation](/note/AI-Agent/evaluation) | 理解 Trace 记录、自动评测、失败样本沉淀 |
| 17 | Production Engineering | [Production Engineering](/note/AI-Agent/production) | 理解部署、监控、成本控制、Prompt 管理 |
...
| Tool Calling | [API 安全](/note/Engineering/api-security)、[Tool Registry 工程化](/note/Engineering/tool-registry-engineering)、[Responses API Tool Orchestration](/note/Engineering/responses-api-tool-orchestration)、[MCP Resources and Prompts Design](/note/Engineering/mcp-resources-prompts-design)、[MCP Server](/note/Engineering/mcp-server)、[MCP Gateway 架构](/note/Engineering/mcp-gateway-architecture) |
| Browser / Computer Use | [Computer Use Agent Safety](/note/Engineering/computer-use-agent-safety)、[Agent 安全威胁模型](/note/Engineering/agent-security-threat-model)、[Agent Trace](/note/Engineering/agent-trace)、[Browser Agent E2E Acceptance](/topics/browser-agent-e2e-acceptance) |
| Agent Runtime | [OpenAI Agents SDK Engineering](/note/Engineering/openai-agents-sdk-engineering)、[Responses API Tool Orchestration](/note/Engineering/responses-api-tool-orchestration)、[Agent Trace](/note/Engineering/agent-trace)、[异步任务](/note/Engineering/async-task)、[Agent Queue 与 Backpressure](/topics/agent-queue-backpressure) |
| Memory / Persistence | [数据库设计](/note/Engineering/database)、[Agent Memory Store Design](/note/Engineering/agent-memory-store-design)、[Agent Trace](/note/Engineering/agent-trace)、[长期记忆系统设计](/note/AI-Agent/long-term-memory)、[Agent Memory 评测](/note/Engineering/memory-evaluation-for-agents) |
...
| Browser / Computer Use | [Agent 面试追问库](/note/AI-Interview/agent-followup-interview) |
...
| Tool Calling | [Tool Calling](/note/AI-Agent/tool-calling) | [Responses API Tool Orchestration](/note/Engineering/responses-api-tool-orchestration)、[API 安全](/note/Engineering/api-security)、[MCP Resources and Prompts Design](/note/Engineering/mcp-resources-prompts-design)、[MCP Server](/note/Engineering/mcp-server) | [LLM 工具调用面试题](/note/AI-Interview/llm-tools-interview) |
| Browser / Computer Use | [Browser / Computer Use Agent](/note/AI-Agent/browser-computer-use-agent) | [Computer Use Agent Safety](/note/Engineering/computer-use-agent-safety)、[Agent 安全威胁模型](/note/Engineering/agent-security-threat-model)、[Agent Trace](/note/Engineering/agent-trace)、[Browser Agent E2E Acceptance](/topics/browser-agent-e2e-acceptance) | [Agent 面试追问库](/note/AI-Interview/agent-followup-interview) |
| Agent Runtime | [Agent Runtime](/note/AI-Agent/agent-runtime) | [OpenAI Agents SDK Engineering](/note/Engineering/openai-agents-sdk-engineering)、[Responses API Tool Orchestration](/note/Engineering/responses-api-tool-orchestration)、[Agent Trace](/note/Engineering/agent-trace) | [Agent 面试题](/note/AI-Interview/agent-interview) |
| Memory / Persistence | [Memory / Persistence](/note/AI-Agent/memory) | [数据库设计](/note/Engineering/database)、[Agent Memory Store Design](/note/Engineering/agent-memory-store-design)、[Agent Trace](/note/Engineering/agent-trace) | [Agent 面试题](/note/AI-Interview/agent-interview) |
