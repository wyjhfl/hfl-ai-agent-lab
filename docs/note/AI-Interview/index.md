...
| Agent 协议与工具生态 | [Tool Calling](/note/AI-Agent/tool-calling)、[Browser / Computer Use Agent](/note/AI-Agent/browser-computer-use-agent) | [Tool Registry 工程化](/note/Engineering/tool-registry-engineering)、[Agent 协议全景](/topics/agent-protocol-landscape)、[MCP Server 创建实战](/note/Engineering/mcp-server-build-guide)、[MCP Tool Schema 设计](/note/Engineering/mcp-tool-schema-design)、[MCP Client 工程化](/note/Engineering/mcp-client-engineering)、[MCP Gateway 架构](/note/Engineering/mcp-gateway-architecture)、[MCP 安全与授权](/note/Engineering/mcp-security-auth) |
...
| AI 系统设计题 | [Agent 系统设计面试题](/topics/agent-system-design-interview)、[Agent 开发 Playbook](/topics/agent-development-playbook) | [Agent Capability Matrix](/topics/agent-capability-matrix)、[Agent 系统设计案例库](/topics/agent-system-design-casebook)、[AI 项目设计文档模板](/topics/ai-project-design-doc-template)、[AI Agent 作品集 Case Study 模板](/topics/ai-agent-portfolio-case-study-template)、[AI Agent PRD 模板](/topics/ai-agent-prd-template)、[Agent Workflow 状态机设计](/note/Engineering/agent-workflow-state-machine)、[Agent Benchmark 设计](/note/Engineering/agent-benchmark-design)、[Agent Release Gate](/note/Engineering/agent-release-gate)、[生产级 Agent 治理清单](/topics/production-agent-governance-checklist) |
