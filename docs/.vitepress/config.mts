      ...
      '/projects/': [
        {
          ...
          items: [
            ...
            {
              text: 'Project A：Agentic RAG',
              collapsed: true,
              items: [
                { text: '主入口', link: '/projects/project-a-rag-workorder' },
                { text: '架构设计', link: '/projects/project-a-architecture' },
                { text: 'Quality / Eval', link: '/projects/project-a-eval-plan' },
                { text: 'Demo 验收', link: '/projects/project-a-demo-script' },
              ],
            },
            {
              text: 'Project B：Multi-Agent Runtime',
              collapsed: true,
              items: [
                { text: '主入口', link: '/projects/project-b-agent-copilot' },
                { text: '架构设计', link: '/projects/project-b-architecture' },
                { text: 'Operator Console', link: '/projects/project-b-ui-blueprint' },
          ...
          items: [
            { text: 'AI 工具总览', link: '/note/AI-Tools/' },
            {
              ...
              items: [
                ...
                { text: '作品集 UI 检查流', link: '/note/AI-Tools/ui-design-skill-research' },
              ],
            },
            {
              text: 'Skills 编写与评测',
      ...
      '/note/Interview/': [
        {
          ...
          items: [
            { text: '表达总览', link: '/note/Interview/' },
            {
              ...
              collapsed: false,
              items: [
                { text: 'Project A 一分钟介绍', link: '/note/Interview/project-a-one-minute' },
                { text: 'Project A 深挖问答', link: '/note/Interview/project-a-deep-dive' },
                { text: 'Project B 一分钟介绍', link: '/note/Interview/project-b-one-minute' },
                { text: 'Project B 深挖问答', link: '/note/Interview/project-b-deep-dive' },
