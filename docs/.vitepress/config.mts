      ...
      '/projects/': [
        {
          ...
          items: [
            ...
            { text: 'Project C：MCP Gateway / Skill Hub', link: '/projects/project-c-mcp-gateway-skill-hub' },
            { text: 'Project C 架构设计', link: '/projects/project-c-architecture' },
            { text: 'Project C Gateway Console UI', link: '/projects/project-c-gateway-console-ui' },
            { text: 'Project C Demo 验收', link: '/projects/project-c-demo-script' },
            { text: 'Project C 安全与评测', link: '/projects/project-c-security-eval-plan' },
            { text: 'Project D：Evaluation / Red Team Lab', link: '/projects/project-d-agent-evaluation-redteam-lab' },
            { text: 'Project D 架构设计', link: '/projects/project-d-eval-architecture' },
            { text: 'Project D 红队样本库', link: '/projects/project-d-redteam-playbook' },
            { text: 'Project D Eval Dashboard', link: '/projects/project-d-eval-dashboard-ui' },
            { text: 'Project D Demo 验收', link: '/projects/project-d-demo-script' },
            { text: 'Project E：AI Coding Agent Workbench', link: '/projects/project-e-ai-coding-agent-workbench' },
            { text: 'Project E 架构设计', link: '/projects/project-e-architecture' },
            { text: 'Project E Code Review Bench', link: '/projects/project-e-code-review-bench' },
            { text: 'Project E Repo Console UI', link: '/projects/project-e-repo-automation-console-ui' },
            { text: 'Project E Demo 验收', link: '/projects/project-e-demo-script' },
            { text: 'Project E 安全与评测', link: '/projects/project-e-safety-eval-plan' },
